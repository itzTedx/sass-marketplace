  ...
  const perks = [
    {
      ...
      description:
        'Get your assets delivered to your email in seconds and them right away',
    },
    {
      name: 'Gurranted Quality',
      Icon: CheckCircle,
      description:
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-2xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to DigitalHippo. Every assets on our platform id verified by
